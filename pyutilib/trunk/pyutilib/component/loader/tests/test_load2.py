...
class Test(unittest.TestCase):
    ...
    def test_load1(self):
        ...
        self.assertFileEqualsBaseline(currdir+"load1.out", currdir+"load1.txt")

    def test_load1a(self):
        pyutilib.subprocess.run(sys.executable+" "+currdir+os.sep+"load1a.py "+currdir)
        self.assertFileEqualsBaseline(currdir+"load1a.out", currdir+"load1a.txt")

    def test_load2(self):
        pyutilib.subprocess.run(sys.executable+" "+currdir+os.sep+"load2.py "+currdir)
        self.assertFileEqualsBaseline(currdir+"load2.out", currdir+"load2.txt")

    def test_load2a(self):
        pyutilib.subprocess.run(sys.executable+" "+currdir+os.sep+"load2a.py "+currdir)
        self.assertFileEqualsBaseline(currdir+"load2a.out", currdir+"load2a.txt")
