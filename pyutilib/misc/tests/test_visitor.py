...
class Test(unittest.TestCase):
    ...
    def test_bfs(self):
        ...
        ans = visitor.simple_bfs(self.root)
    ...
    def test_dfs_preorder(self):
        visitor = CollectVisitor()
        ans = visitor.simple_dfs(self.root)
    ...
    def test_dfs_inorder(self):
        visitor = CollectVisitor()
        ans = visitor.simple_dfs_inorder(self.root)
    ...
    def test_dfs_postorder(self):
        visitor = CollectVisitor()
        ans = visitor.simple_dfs_postorder(self.root)
    ...
    def test_retval_dfs_postorder(self):
        visitor = SumVisitor()
        ans = visitor.retval_dfs_postorder(self.root)
        self.assertEqual(ans, 820)

    def test_count_bfs(self):
        cvisitor = CountVisitor()
        ans = cvisitor.simple_bfs(self.root)
        self.assertEqual(ans,40)
        
    def test_count_xbfs(self):
        cvisitor = CountVisitor()
        ans = cvisitor.simple_xbfs(self.root)
        self.assertEqual(ans,40)
