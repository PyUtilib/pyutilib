...
def compare_xml_files(baseline_fname, output_fname, tolerance=0.0, baseline_begin='', baseline_end='', output_begin='', output_end=None, exact=True):
    ...
    return compare_repn(baseline_repn, output_repn, tolerance=tolerance, exact=exact)
