...
setup(name="PyUtilib",
    ...
    classifiers = [
      ...
      install_requires=[
            'pyutilib.autotest>=1.4.2',
            'pyutilib.common>=3.0.4',
            'pyutilib.component.app>=3.1.4', 
            'pyutilib.component.config>=3.2.4',
            'pyutilib.component.core>=4.2',
            'pyutilib.component.doc>=1.0.1',
            'pyutilib.component.executables>=3.4',
            'pyutilib.component.loader>=3.2.4',
            'pyutilib.dev>=1.13',
            'pyutilib.enum>=1.0.5',
